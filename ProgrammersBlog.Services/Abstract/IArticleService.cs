...
namespace ProgrammersBlog.Services.Abstract
{
    public interface IArticleService
    {
        ...
        Task<IDataResult<ArticleListDto>> GetAllByUserIdOnFilter(int userId, FilterBy filterBy, OrderBy orderBy,
            ...
            DateTime startAt, DateTime endAt, int minViewCount, int maxViewCount, int minCommentCount,
            int maxCommentCount);
        ...
        Task<IResult> UpdateAsync(ArticleUpdateDto articleAUpdateDto, string modifiedByName);
